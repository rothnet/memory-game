...
export class Play extends Phaser.Scene
{
    ...
    createWinnerForm() {
        ...
        // יצירת תיבות קלט HTML
        const inputStyle = 'direction: rtl; padding: 10px; margin: 5px; width: 200px;';
        ...
        form.innerHTML = `
            <input type="text" placeholder="שם מלא" style="${inputStyle}"><br>
            <input type="email" placeholder="אימייל" style="${inputStyle}"><br>
            <button style="margin-top: 10px; padding: 10px 20px; 
                           background: #8c7ae6; color: white; 
    ...
    startGame ()
    {
        ...
        const winnerText = this.add.text(this.sys.game.scale.width / 2, -1000, "! ניצחת",
            { align: "center", strokeThickness: 4, fontSize: 40, fontStyle: "bold", color: "#8c7ae6" }
        ).setOrigin(.5)
            .setDepth(3)
            .setInteractive();
